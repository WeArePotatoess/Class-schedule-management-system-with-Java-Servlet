            ...
            <div class="switch-wrap">
                <div class="profile-container">
                    ...
                    <div class="info-container">
                        <div class="container">
                            <input required="" type="text" class="input" value="${student.code}" disabled="">
                            <label class="label">Student code</label>
                        </div>
                        <div class="container">
                            <input required="" type="text" name="name" class="input" value="${student.studentName}" disabled="">
                            <label class="label">
                                Full name
                            </label>
                        </div>
                        ...
                        <div class="container">
                            <input required="" type="date" name="dob" class="input custom-date-input" value="${student.dob}" disabled="">
                            <label class="label">
                                Date of Birth
                            </label>
                        </div>
                        <div class="container">
                            <input required="" type="text" class="input" value="${student.getMajorName()}" disabled="">
                            <label class="label">
                                Major
                            </label>
                        </div>
